...
theta=deg_rad(int(input("Give me the Theta : ")))
phi=deg_rad(int(input("Give me the Phi : ")))
...
anim = FuncAnimation(fig, animate, init_func=init, frames=1024, interval=10, blit=True)
